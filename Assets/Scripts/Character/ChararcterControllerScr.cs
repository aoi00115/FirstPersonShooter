...
public class CharacterControllerScr : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        defaultInput.Character.FireUp.performed += e => weaponController.fireable.FireUp();
        ...
        defaultInput.Character.SwitchFireMode.performed += e => weaponController.fireable.SwitchFireMode();
