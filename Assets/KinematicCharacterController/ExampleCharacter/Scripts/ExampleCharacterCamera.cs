    ...
    public class ExampleCharacterCamera : MonoBehaviour
    {
        ...
        public void UpdateWithInput(float deltaTime, float zoomInput, Vector3 rotationInput)
        {
            if (FollowTransform)
            {
                ...
                // Transform.rotation = planarRot * verticalRot;
                ...
                // Find the instant camera orbit position
                // Vector3 targetPosition = _currentFollowPosition - ((planarRot * verticalRot; * Vector3.forward) * _currentDistance);
